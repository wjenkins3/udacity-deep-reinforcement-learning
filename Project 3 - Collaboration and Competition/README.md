...
For this project, an agent was trained in the [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
3. Place the file in a location of your chosing and unzip (or decompress) the file. Remember the file location; you'll need it in the next step.
