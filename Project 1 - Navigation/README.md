...
The task is episodic, and in order to solve the environment, the agent needed to get an average score of +13 over 100 consecutive episodes.
...
Follow the instructions in `Navigation.ipynb` to get started with training the agent or skip the training and watch a trained agent navigate the environment!  
